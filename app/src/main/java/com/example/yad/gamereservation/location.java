...
public class location extends AppCompatActivity {
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                url = new URL("http://192.168.1.14:8080/gameservervation/cegepgim/gamereservation/viewlocations");
                ...
                if (status.equals("ok")) {
                    ...
                    ary = obj.getJSONArray("Locations");
                    for (Integer i = 0; i < ary.length(); i++) {
                        JSONObject obj1 = ary.getJSONObject(i);
                          String  o1 = obj1.getString("LocationName");

                        HashMap<String, String> contact = new HashMap<>();

                        // adding each child node to HashMap key => value

                        contact.put("LocationName", o1);
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    location.this, arylist,
                    R.layout.list_item, new String[]{"LocationName"}, new int[]{R.id.name});
